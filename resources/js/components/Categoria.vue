                    ...
                    <div class="card-header bg-transparent border-0">
                        <div class="row mt-2">
                            <div class="col-md-12 text-right">
                                <button class="btn btn-primary" type="button" @click="abrirModal('categoria','registrar')">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                                    ...
                                    <td class="text-center align-middle" v-text="categoria.nombre"></td>
                                    <td class="text-center align-middle" v-text="categoria.descripcion"></td>

                                    <td class="text-center align-middle">
                                        <span class="badge badge-success px-3 py-2" v-if="categoria.condicion">
                                    ...
                                    <td class="text-center align-middle">
                                        <button style="color: white !important" type="button" class="btn btn-info btn-sm" @click="abrirModal('categoria','actualizar',categoria)">
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" @click="registrarCategoria()" v-if="tipoAccion==1" class="btn btn-success"><i class="fa fa-save"></i> Guardar</button>
                            <button type="button" @click="actualizarCategoria()" v-if="tipoAccion==2" class="btn btn-success"><i class="fa fa-save"></i> Actualizar</button>
