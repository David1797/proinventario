                ...
                <div class="card">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr v-for="venta in arrayVenta" :key="venta.id">
                                        ...
                                        <td>
                                             <!--compra.id-->
                                            <button style="color: white !important" type="button" @click="verVenta(venta.id)" class="btn btn-dark btn-sm">
                                        ...
                                        <td>
                                             ...
                                             <button style="color: white !important" type="button" @click="pdfVenta(venta.id)" class="btn px-3 btn-info btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    <label><strong>Número Venta(*)</strong></label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                    <button @click="agregarDetalle()" class="btn btn-primary form-control btnagregar"><i class="fa fa-plus"></i> Agregar detalle</button>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-danger" @click="ocultarDetalle()"><i class="fa fa-times"></i> Cerrar</button>
                                <button type="button" class="btn btn-success" @click="registrarVenta()"><i class="fa fa-save"></i> Registrar Venta</button>
                            </div>
                        </div>
                    </div>
                    </template>
                    ...
                    <h4 class=" mt-4 text-center">Detalle de Venta</h4><br/>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <button type="button" @click="ocultarDetalle()" class="btn btn-danger"><i class="fa fa-times"></i> Cerrar</button>
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" @click="cerrarModal()" class="btn btn-danger"><i class="fa fa-times"></i> Cerrar</button>
                            <button type="button" @click="registrarUsuario()" v-if="tipoAccion==1" class="btn btn-success"><i class="fa fa-save"></i> Guardar</button>
                            <button type="button" @click="actualizarUsuario()" v-if="tipoAccion==2" class="btn btn-success"><i class="fa fa-save"></i> Actualizar</button>
        ...
        methods:{
           ...
           selectCliente(search,loading){
            ...
            getDatosCliente(val1){
             ...
             pdfVenta(id){
                 window.open(window.URL +'/venta/pdf/'+ id ,'_self');
            },
