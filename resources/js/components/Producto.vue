                    ...
                    <div class="card-header bg-transparent border-0">
                        <div class="row mt-2">
                            <div class="col-md-12 text-right">
                                <button class="btn btn-primary" type="button" @click="abrirModal('producto','registrar')">
                                    <i class="fa fa-plus"></i>&nbsp;&nbsp;Agregar Producto
                                </button>
                                <button type="button" class="btn btn-success" @click="cargarPdf();">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr v-for="producto in arrayProducto" :key="producto.id">
                                    ...
                                    <td class="text-center align-middle" v-text="producto.nombre_categoria"></td>
                                    <td class="text-center align-middle" v-text="producto.nombre"></td>
                                    <td class="text-center align-middle" v-text="producto.codigo"></td>
                                    <td class="text-center align-middle" v-text="producto.precio_venta"></td>
                                    <td class="text-center align-middle" v-text="producto.stock"></td>
                                    ...
                                    <td class="text-center align-middle">
                                        <span class="badge badge-success px-3 py-2" v-if="producto.condicion">
                                          <i class="fa fa-check"></i> Activo

                                        </span>
                                        <span class="badge badge-danger px-3 py-2" v-else>
                                    ...
                                    <td class="text-center align-middle">
                                        <button style="color: white !important" type="button" class="btn btn-info btn-sm" @click="abrirModal('producto','actualizar',producto)">
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                               ...
                               <div class="form-group row">
                                    ...
                                    <div class="col-md-9 text-center">
                                        ...
                                        <div v-if="tipoAccion==1">
                                            ...
                                            <img :src="imagen" class="img-responsive mt-2" width="200px" height="200px">
                                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" @click="registrarProducto()" v-if="tipoAccion==1" class="btn btn-success"><i class="fa fa-save"></i> Guardar</button>
                            <button type="button" @click="actualizarProducto()" v-if="tipoAccion==2" class="btn btn-success"><i class="fa fa-save"></i> Actualizar</button>
   ...
   import VueBarcode from 'vue-barcode';
    ...
    export default {
        ...
        methods:{
           ...
           cargarPdf(){
               window.open(window.URL +"/producto/listarPdf",'_self');
            },
