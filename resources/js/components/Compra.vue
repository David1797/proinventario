        ...
        <div class="container-fluid">
            ...
            <div class="card">
                    ...
                    <div class="card-header bg-transparent border-0">
                        <div class="row">
                            <div class="col-md-12 text-right mt-2">
                                <button class="btn btn-primary" type="button" @click="mostrarDetalle()">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" @keyup.enter="listarCompra(1,buscar,criterio);" v-model="buscar"
                                           class="form-control" placeholder="Buscar texto">
                                    <button type="submit" @click="listarCompra(1,buscar,criterio);"
                        ...
                        <table class="table">
                            ...
                            <tr v-for="compra in arrayCompra" :key="compra.id">
                                ...
                                <td>
                                    <!--compra.id-->
                                    <button style="color: white !important" type="button" @click="verCompra(compra.id)" class="btn btn-dark btn-sm">
                                ...
                                <td>
                                    ...
                                    <button style="color: white !important" type="button" @click="pdfCompra(compra.id)" class="btn btn-info btn-sm px-3">
                ...
                <template v-else-if="listado==0">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><strong>Número Compra(*)</strong></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><strong>Tipo Identificación(*)</strong></label>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Producto <!--<span class="text-error" v-show="idproducto==0">
                                        (*Ingrese código del producto)</span>--></label>
                                    <div class="form-inline">
                                        <input type="text" class="form-control" v-model="codigo"
                                               @keyup.enter="buscarProducto()" placeholder="Ingrese código">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Precio <!--<span class="text-error"
                                                        v-show="precio==0">(*Ingrese un valor)</span>--></label>
                                    <input type="number" value="0" step="any" class="form-control" v-model="precio">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Cantidad <!--<span class="text-error"
                                                          v-show="cantidad==0">(*Ingrese un valor)</span>--></label>
                                    <input type="number" value="0" class="form-control" v-model="cantidad">
                                </div>
                            </div>
                            <div class="col-md-2 d-flex align-items-center">
                                <button @click="agregarDetalle()" class="btn btn-primary form-control mt-3"><i
                                    class="fa fa-plus"></i> Agregar detalle
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive col-md-12">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr style="background-color: grey;">
                                        ...
                                        <td><strong>USD$
                                            {{subTotalImpuesto=((total*impuesto)/(1+impuesto)).toFixed(2)}}</strong>
                                        </td>
                                    </tr>
                                    <tr style="background-color: grey;">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <button type="button" class="btn btn-success" @click="registrarCompra()"><i
                                    class="fa fa-save"></i> Registrar Compra
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <template v-else-if="listado==2">
                    ...
                    <h4 class="mt-4 text-center">Detalle de Compra</h4><br/>
                            ...
                            <div class="table-responsive col-md-12">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr style="background-color: grey;">
                                        ...
                                        <td><strong>USD$ {{subTotalImpuesto=((total*impuesto)).toFixed(2)}}</strong>
                                        </td>
                                    </tr>
                                    <tr style="background-color: grey;">
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tr v-for="producto in arrayProducto" :key="producto.id">
                                    ...
                                    <td>
                                        ...
                                        <img :src="'img/producto/' + producto.imagen" class="img-responsive"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" @click="registrarUsuario()" v-if="tipoAccion==1" class="btn btn-success">
                            <i class="fa fa-save"></i> Guardar
                        </button>
                        <button type="button" @click="actualizarUsuario()" v-if="tipoAccion==2" class="btn btn-success">
    ...
    export default {
        ...
        methods: {
            ...
            pdfCompra(id) {
                ...
                window.open(window.URL +'/compra/pdf/' + id ,'_self');
...
<style>
    ...
    .dropdown.v-select.single.searchable > .dropdown-toggle::after {
