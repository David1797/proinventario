                    ...
                    <div class="card-header bg-transparent border-0">
                        <div class="row mt-2">
                            <div class="col-md-12 text-right">
                                <button class="btn btn-primary" type="button" @click="abrirModal('usuario','registrar')">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr v-for="usuario in arrayUsuario" :key="usuario.id">
                                    ...
                                    <td>
                                        <button style="color: white !important;" type="button" class="btn btn-info btn-sm" @click="abrirModal('usuario','actualizar',usuario)">
                                    ...
                                    <td>
                                        ...
                                        <template v-if="usuario.condicion">
                                            <button type="button" class="btn btn-success btn-sm" @click="desactivarUsuario(usuario.id)">
                                                <i class="fa fa-unlock"></i> Activado
                                            </button>
                                        </template>
        ...
        methods:{
           ...
           registrarUsuario(){
            ...
            validarUsuario(){
                ...
                if (!this.imagen) this.errorMostrarMsjUsuario.push("(*)Debe subir una imagen");
