                    ...
                    <div class="card-header bg-transparent border-0">
                        <div class="row mt-2">
                            <div class="col-md-12 text-right">
                                <button class="btn btn-primary" type="button" @click="abrirModal('proveedor','registrar')">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr v-for="proveedor in arrayProveedor" :key="proveedor.id">
                                    ...
                                    <td>
                                        <button style="color: white !important" type="button" class="btn  btn-info btn-sm" @click="abrirModal('proveedor','actualizar',proveedor)">
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" @click="registrarProveedor()" v-if="tipoAccion==1" class="btn btn-success"><i class="fa fa-save"></i> Guardar</button>
                            <button type="button" @click="actualizarProveedor()" v-if="tipoAccion==2" class="btn btn-success"><i class="fa fa-save"></i> Actualizar</button>
