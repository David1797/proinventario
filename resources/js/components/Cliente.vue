                    ...
                    <div class="card-header bg-transparent border-0">
                        <div class="row">
                            <div class="col-md-12 mt-2 text-right">
                                <button class="btn btn-primary" type="button" @click="abrirModal('cliente','registrar')">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr v-for="cliente in arrayCliente" :key="cliente.id">
                                    ...
                                    <td>
                                        <button style="color: white !important;" type="button" class="btn btn-info btn-sm" @click="abrirModal('cliente','actualizar',cliente)">
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" @click="registrarCliente()" v-if="tipoAccion==1" class="btn btn-success"><i class="fa fa-save"></i> Guardar</button>
                            <button type="button" @click="actualizarCliente()" v-if="tipoAccion==2" class="btn btn-success"><i class="fa fa-save"></i> Actualizar</button>
